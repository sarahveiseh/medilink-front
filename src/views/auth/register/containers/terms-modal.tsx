...
export const TermsModal: React.FC<Props> = ({ setShowModal }) => {
  return (
    <Modal
      ...
      className="p-3 border-t-2 border-b-2 mb-5 leading-relaxed"
    >
      <p>
        <h1>Welcome to Utopiops!</h1>
        These terms and conditions outline the rules and regulations for the use
        of Utopiops , located at Utopiops.com.
      </p>
      <br />

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Utopiops if you do not agree to take
      ...
      <p>
        <h1>Cookies</h1>
        We employ the use of cookies. By accessing Utopiops, you agreed to use
        cookies in agreement with the Utopiops Privacy Policy.
      </p>
      <br />
      ...
      <p>
        <h1>License</h1>
        Unless otherwise stated, Utopiops and/or its licensors own the
        intellectual property rights for all material on Utopiops. All
        intellectual property rights are reserved. You may access this from
        Utopiops for your own personal use subjected to restrictions set in
      ...
      <p>
        <h1>You must not:</h1>
        Republish material from Utopiops Sell, rent or sub-license material from
        Utopiops Reproduce, duplicate or copy material from Utopiops
        Redistribute content from Utopiops This Agreement shall begin on the
        date hereof.
      </p>
      <br />
      ...
      <p>
        ...
        Utopiops does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Utopiops,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Utopiops shall not be liable
      ...
      <p>
        {' '}
        Utopiops reserves the right to monitor all Comments and to remove any
      ...
      <p>
        <h1>You warrant and represent that:</h1>
        ...
        unlawful activity. You hereby grant Utopiops a non-exclusive license to
      ...
      <p>
        ...
        The following organizations may link to our Utopiops without prior
        written approval: Government agencies; Search engines; News
        organizations; Online directory distributors may link to our Utopiops in
        ...
        Utopiops information so long as the link: (a) is not in any way
      ...
      <p>
        ...
        the hyperlink compensates the absence of Utopiops; and (d) the link is
      ...
      <p>
        ...
        e-mail to Utopiops. Please include your name, your organization name,
        contact information as well as the URL of your site, a list of any URLs
        from which you intend to link to our Utopiops, and a list of the URLs on
      ...
      <p>
        <h1>
          Approved organizations may hyperlink to our Utopiops as follows:
        </h1>
        By use of our corporate name; or By use of the uniform resource locator
        being linked to; or By use of any other description of our Utopiops
        being linked to that makes sense within the context and format of
        content on the linking party's site. No use of Utopiops logo or other
      ...
      <p>
        ...
        Utopiops. You agree to protect and defend us against all claims that is
        rising on your Utopiops. No link(s) should appear on any Utopiops that
      ...
      <p>
        ...
        particular link to our Utopiops. You approve to immediately remove all
        links to our Utopiops upon request. We also reserve the right to amen
        these terms and conditions and it's linking policy at any time. By
        continuously linking to our Utopiops, you agree to be bound to and
      ...
      <p>
        ...
        If you find any link on our Utopiops that is offensive for any reason,
