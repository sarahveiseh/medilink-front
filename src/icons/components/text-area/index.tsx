          ...
          <div className="relative flex flex-col items-start w-full">
            ...
            <textarea
              ...
              className={classNames(
                ' w-full  rounded focus:outline-none focus:shadow h-24 p-3  text-gray-900 bg-white placeholder-gray-500 dark:bg-gray-400 dark:placeholder-gray-700 disabled:bg-gray-100 disabled:text-gray-500',
                error
